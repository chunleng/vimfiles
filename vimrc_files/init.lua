...
require('packer').startup(function(use)
    ...
    use {
        ...
        config = function() require("galaxyline-nvim-config") end,
        after = "nvim-base16"
    }
    use {
    ...
    use {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("v", "za",
                                    ...
                                    {silent = true, noremap = true})
            local base16 = require("base16-colorscheme")
            vim.highlight.create("IndentBlanklineChar",
                                 {guifg = base16.colors.base02}, false)
        end,
        requires = "dstein64/nvim-scrollview",
        after = {"nvim-base16", "nvim-scrollview"}
    }
    ...
    use {
        ...
        config = function()
                ...
                current_line_blame_formatter = function(name, blame_info)
                    ...
                    return {
                        ...
                        {'  ', 'GitSignsCurrentLineBlameAccent'}, {
                            string.format("%s on %s", author, os.date(
                                              "%Y/%m/%d", blame_info.author_time)),
                            "GitSignsCurrentLineBlame"
                        }, {'  ', "GitSignsCurrentLineBlameAccent"},
            ...
            vim.highlight.create("GitSignsCurrentLineBlameNoBg",
                                 {guibg = "none"}, false)
    ...
    use {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("n", "<leader>/", ":FzfLua resume<cr>",
                                    {silent = true})
            vim.api.nvim_set_keymap("n", "<c-_>", ":FzfLuaSearch<cr>",
                                    {silent = true})
            ...
            vim.highlight.create("FzfLuaFloatPreviewCursorLine", {gui = "none"},
                                 false)
            vim.highlight.create("FzfLuaFloatInfo",
                                 {guifg = base16.colors.base0D_40}, false)
            vim.highlight.create("FzfLuaFloatPrompt",
                                 {guifg = base16.colors.base03}, false)
            vim.highlight.create("FzfLuaFloatPointer",
                                 {guifg = base16.colors.base03}, false)
            vim.highlight.create("FzfLuaFloatMarker",
                                 {guifg = base16.colors.base06}, false)
        end,
    ...
    use {
        ...
        config = function()
            ...
            local js_kind = {
                ...
                "Module", "Method", "Struct", "Constant", "Variable", "Field"
            }
    ...
    use {
        ...
        config = function()
            ...
            -- blue
            vim.highlight.create("CmpItemAbbrMatch",
                                 {guifg = base16.colors.base0D}, false)
            vim.highlight.create("CmpItemAbbrMatchFuzzy",
                                 {guifg = base16.colors.base0D}, false)
            -- orange
            vim.highlight.create("CmpItemKindFunction",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindMethod",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindConstructor",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindClass",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindInterface",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindModule",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindEnum",
                                 {guifg = base16.colors.base09}, false)
            vim.highlight.create("CmpItemKindStruct",
                                 {guifg = base16.colors.base09}, false)
            -- turquoise
            vim.highlight.create("CmpItemKindVariable",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindText",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindField",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindProperty",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindValue",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindEnumMember",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindTypeParameter",
                                 {guifg = base16.colors.base0C}, false)
            vim.highlight.create("CmpItemKindConstant",
                                 {guifg = base16.colors.base0C}, false)
            -- yellow
            vim.highlight.create("CmpItemKindUnit",
                                 {guifg = base16.colors.base0A}, false)
            vim.highlight.create("CmpItemKindKeyword",
                                 {guifg = base16.colors.base0A}, false)
            vim.highlight.create("CmpItemKindOperator",
                                 {guifg = base16.colors.base0A}, false)
            vim.highlight.create("CmpItemKindColor",
                                 {guifg = base16.colors.base0A}, false)
            -- default
    ...
    use {
        ...
        config = function()
            ...
            vim.highlight.create("DiffAdd", {guifg = "none", guibg = "none"},
                                 false)
            ...
            vim.highlight.create("DiffChange", {guifg = "none", guibg = "bg"},
                                 false)
            ...
            vim.highlight.create("PmenuSbar", {guibg = base16.colors.base0D_20},
                                 false)
            ...
            vim.highlight.link("DiagnosticVirtualTextError",
                               "DiagnosticVirtualText", false)
            vim.highlight.link("DiagnosticVirtualTextWarn",
                               "DiagnosticVirtualText", false)
            vim.highlight.link("DiagnosticVirtualTextInfo",
                               "DiagnosticVirtualText", false)
            vim.highlight.link("DiagnosticVirtualTextHint",
                               "DiagnosticVirtualText", false)
    ...
    use {
        ...
        config = function()
            ...
            local base16 = require("base16-colorscheme")
            vim.highlight.create("DashboardHeader",
                                 {guifg = base16.colors.base0D_40}, false)
            vim.highlight.create("DashboardCenter",
                                 {guifg = base16.colors.base0D}, false)
            vim.cmd [[
          augroup Dashboard
            autocmd!
