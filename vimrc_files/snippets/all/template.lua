...
table.insert(M, s({trig = '?date', dscr = 'Insert current date'}, fmta([[
	<>
]], {f(function() return os.date('%Y-%m-%d') end)})))

table.insert(M, s({trig = '?time', dscr = 'Insert current time'}, fmta([[
	<>
]], {f(function() return os.date('%X') end)})))

table.insert(M,
             s({trig = '?datetime', dscr = 'Insert current datetime'}, fmta([[
	<>
